 ...
 //}
    ...
    <div class="infobox">
      ...
      <div class="infotextbox">
        ...
        <br> <br> 
        <center>
        <button class="btndl"> <a href=""> <i class="fa-solid fa-circle-play fa-spin"></i> Watch 720p  </a></button>
        <button class="btndl"> <a href=""> <i class="fa-solid fa-circle-play fa-spin"></i> Watch 1080p </a></button>
        <button class="btndl"> <a href=""> <i class="fa-solid fa-circle-play fa-spin"></i> Watch <span style="font-size: 12px;color: whitesmoke;">from fastest server</span>  </a></button>   
      </center>
